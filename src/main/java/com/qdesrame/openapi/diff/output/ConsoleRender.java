...
public class ConsoleRender implements Render {
  ...
  private String itemContent(
    ...
    sb.append(itemContent(title, contentType))
        ...
        .append(list_Schema(changedMediaType.getSchema(),1))
        .append(System.lineSeparator());
    return sb.toString();
  }
  ...
  private String list_Schema(ChangedSchema changedSchema, int identationLevel){
